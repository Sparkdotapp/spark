    ...
    <section className="relative min-h-screen flex items-center justify-center pt-[72px] overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <Link href="/events" className="group relative px-8 py-4 text-base font-semibold rounded-xl bg-[#DAFF01] text-[rgb(17,17,19)] transition-all duration-200 hover:bg-[rgb(166,190,21)] hover:shadow-[0_8px_30px_rgba(218,255,1,0.35)] hover:-translate-y-0.5 active:translate-y-0 overflow-hidden min-w-[200px]">
            ...
            <Link href="/social" className="group flex items-center gap-3 px-8 py-4 text-base font-semibold rounded-xl border-2 border-[rgb(63,63,63)] text-white transition-all duration-200 hover:border-[#DAFF01] hover:text-[#DAFF01] hover:bg-[rgba(218,255,1,0.05)] hover:-translate-y-0.5 active:translate-y-0 min-w-[200px] justify-center">
              Watch Social
            </Link>
          </motion.div>
